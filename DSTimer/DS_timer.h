...
public:
	...
	void setTimerName (UINT id, const std::string &_name) { timerName[id] = _name ; }
	...
	void printToFile ( const char* fileName, int _id = -1 ) ;
	void printTimerNameToFile ( const char* fileName ) ;
} ;
